...
int pvrtc_compress(	void*	InputARGBData,
...
*/
/******************************************************************************/
int pvrtc_decompress(	void*	OutputARGBData,
...
void pvrtc_get_version(unsigned int *uMajor, unsigned int *uMinor, unsigned int *uInternal, unsigned int *uBuild);
